...
from logger import (Colors, log_error, log_info, log_header, log_success, 
                    log_warning)
...
os.environ["SSL_CERT_FILE"] = certifi.where()  # Set SSL_CERT_FILE environment variable
os.environ["REQUESTS_CA_BUNDLE"] = certifi.where()  # Set REQUESTS_CA_BUNDLE environment variable
...
async def main():
    ...
    log_info(
       "🗺️  TavilyCrawl: Starting to crawl the documentation site from https://python.langchain.com/",
        Colors.PURPLE,
  )
